...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, index_1.connectToDb()];
            case 1:
                _a.sent();
                app.use('/api/products', productRoutes_1.router);
                app.use('/api/users/', userRoutes_1.router);
                app.use('/api/orders/', orderRoutes_1.router);
                app.use('/api/upload/', uploadRoutes_1.router);
